    ...
    public static void main(String[] args){
        ...
        for (int i=1; i<=4; i++){
            if(truk.muatan<=truk.muatanMax){
                ...
                // dengan parameter muatanInData yang dimasukkan ke variabel berat
                // pada method tersebut, selanjutnya melakukan operasi aritmetika
        ...
        // jika muatan>1000 akan mencetak total, kelebihan, dan nilai kembalian
